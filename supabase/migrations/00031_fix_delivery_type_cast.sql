-- ============================================================================
-- Migration 00031: Fix delivery_type Cast in create_transaction_atomic
-- ============================================================================
-- This migration fixes a bug where delivery_type wasn't being cast to the
-- delivery_type enum, causing errors when creating transactions.
-- ============================================================================

-- Simply recreate the function with the correct cast
-- This is a copy of the function from 00027 with the delivery_type cast fixed
...
BEGIN
    ...
    INSERT INTO transactions (
        ...
        p_delivery_type::delivery_type,  -- ← FIXED: Added cast to delivery_type enum
        p_delivery_address,
        p_delivery_phone,
        p_notes,
        p_subtotal,
...
COMMENT ON FUNCTION create_transaction_atomic IS 
  'Fixed version: Creates transaction atomically with proper delivery_type enum casting, stock validation, and row-level locking.';
