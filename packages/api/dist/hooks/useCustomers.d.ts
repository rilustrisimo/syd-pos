...
export declare const useUpsertCustomer: () => import("@tanstack/react-query").UseMutationResult<any, Error, Partial<Customer>, unknown>;
export declare const useGetOrCreateWalkIn: () => import("@tanstack/react-query").UseMutationResult<Customer, Error, string, unknown>;
